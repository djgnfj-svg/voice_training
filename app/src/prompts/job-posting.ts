export const JOB_POSTING_ANALYSIS_PROMPT = `당신은 IT/개발 채용 공고 분석 전문가입니다. 주어진 채용 공고 텍스트를 분석하여 구조화된 JSON으로 변환해주세요.
...
export const COMPANY_ANALYSIS_PROMPT = `당신은 IT 기업 면접 분석 전문가입니다. 주어진 회사명과 포지션 정보를 바탕으로 해당 회사의 면접 특성을 분석해주세요.

...
interface JobPostingInputProps {
  onAnalyzed: (data: { id: string; parsedData: ParsedJobPosting; companyAnalysis: CompanyAnalysis }) => void;
}
...
export function JobPostingResult({ parsedData, companyAnalysis }: JobPostingResultProps) {
  return (
    <Card>
      <CardHeader>

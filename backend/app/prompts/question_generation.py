...
INTERVIEW_PLAN_PROMPT = """당신은 개발자 기술 면접 설계 전문가입니다. 채용 공고와 이력서를 분석하여 최적의 면접 계획을 수립해주세요.
...
QUESTION_GENERATION_PROMPT = """당신은 개발자 기술 면접관입니다. 주어진 분석 결과를 바탕으로 맞춤형 면접 질문을 생성해주세요.
...
RESUME_ONLY_PLAN_PROMPT = """당신은 개발자 기술 면접 설계 전문가입니다. 이력서만을 분석하여 최적의 면접 계획을 수립해주세요.
...
RESUME_ONLY_QUESTION_PROMPT = """당신은 개발자 기술 면접관입니다. 이력서를 기반으로 맞춤형 면접 질문을 생성해주세요.
...
DEEP_INTERVIEW_PLAN_PROMPT = """당신은 IT/개발 직무 심화 면접 설계 전문가입니다. 이력서를 분석하여 기술적 깊이를 검증하는 심화 면접 계획을 수립해주세요.
...
DEEP_INTERVIEW_QUESTION_PROMPT = """당신은 IT/개발 직무의 시니어 면접관입니다. 이력서와 참조 주제를 바탕으로 **기술적 깊이를 검증하는 심화 면접 질문**을 생성해주세요.
...
GENERAL_QUESTION_PROMPT = """당신은 개발자 기술 면접관입니다. 다음 설정에 맞는 면접 질문을 생성해주세요.
